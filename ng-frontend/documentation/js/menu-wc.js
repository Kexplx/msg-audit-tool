                ...
                <li class="chapter">
                    ...
                    <li class="chapter modules">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="modules-links"' : 'id="xs-modules-links"' }>
                            <li class="link">
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-8d63277e6ae82daf0b35cf12c5a847cf"' : 'data-target="#xs-components-links-module-AppModule-8d63277e6ae82daf0b35cf12c5a847cf"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-8d63277e6ae82daf0b35cf12c5a847cf"' :
                                            'id="xs-components-links-module-AppModule-8d63277e6ae82daf0b35cf12c5a847cf"' }>
                                            <li class="link">
                                ...
                                <li class="chapter inner">
                                    <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                        'data-target="#directives-links-module-AppModule-8d63277e6ae82daf0b35cf12c5a847cf"' : 'data-target="#xs-directives-links-module-AppModule-8d63277e6ae82daf0b35cf12c5a847cf"' }>
                                        <span class="icon ion-md-code-working"></span>
                                        <span>Directives</span>
                                        <span class="icon ion-ios-arrow-down"></span>
                                    </div>
                                    <ul class="links collapse" ${ isNormalMode ? 'id="directives-links-module-AppModule-8d63277e6ae82daf0b35cf12c5a847cf"' :
                                        'id="xs-directives-links-module-AppModule-8d63277e6ae82daf0b35cf12c5a847cf"' }>
                                        <li class="link">
                            ...
                            <li class="link">
                                <a href="modules/AppNebularModule.html" data-type="entity-link">AppNebularModule</a>
                            </li>
                            <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            <li class="link">
                                <a href="components/EditAuditDialogComponent.html" data-type="entity-link">EditAuditDialogComponent</a>
                            </li>
                        </ul>
                    </li>
                    <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/CustomerData.html" data-type="entity-link">CustomerData</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/Factor.html" data-type="entity-link">Factor</a>
                            </li>
                        </ul>
                    </li>
                    <li class="chapter">
