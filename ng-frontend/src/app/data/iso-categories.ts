...
export const categories: IsoCategory[] = [
  { title: '1. Effektivität'},
  { title: '2. Effizienz'},
  { title: '3. Zufriedenheit', subcategories: [
    { title: '3.1 Nützlichkeit' },
    { title: '3.2 Vertrauen' },
    { title: '3.3 Wohlgefälligkeit' },
    { title: '3.4 Komfort' },
  ] },
  { title: '4. Risikofreiheit', subcategories: [
  ...
  { title: '5. Lieferbestandteile', subcategories: [
    { title: '5.1 Komplette Abdeckung aller Umgebungsanforderungen' },
    { title: '5.2 Flexibilität' },
  ] },
  { title: '6. Funktionale Tauglichkeit', subcategories: [
    { title: '6.1 Funktionale Vollständigkeit' },
    { title: '6.2 Funktionale Richtigkeit' },
    { title: '6.3 Funktionale Angemessenheit' },
  ] },
  { title: '7. Performanz, Effizienz', subcategories: [
    { title: '7.1 Antwortzeitverhalten' },
    { title: '7.2 Ressourcenverbrauch' },
    { title: '7.3 Kapazität' },
  ] },
  { title: '8. Austauschbarkeit, Übertragbarkeit', subcategories: [
    { title: '8.1 Koexistenz' },
    { title: '8.2 Interoperabilität' },
  ] },
  { title: '9. Benutzbarkeit', subcategories: [
  ...
  { title: '12. Wartbarkeit', subcategories: [
  ...
  { title: '13. Portabilität', subcategories: [
